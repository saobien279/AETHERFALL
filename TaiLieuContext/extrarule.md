...
## 9. Quy tắc Tương tác & Học tập (User Working Rules)

> LƯU Ý TỐI QUAN TRỌNG CHO TẤT CẢ AGENT AI TIẼP QUẢN DỰ ÁN:
...
2. **Triết lý "Tiết kiệm Token bằng Docs":** Mọi cơ chế được hai bên chốt phải chủ động tổng hợp và ghi vào `aboutproject.md` hoặc `guide.md`.
3. **Tiết kiệm từ vựng (Concise Communication):** Trình bày thẳng vào vấn đề kỹ thuật. Hạn chế những câu chào hỏi, khen ngợi rườm rà.